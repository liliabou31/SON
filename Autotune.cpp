...
struct mydsp : public dsp {
	...
	void metadata(Meta* m) { 
		...
		m->declare("analyzers.lib/pitchTracker:author", "Dario Sanfilippo");
		m->declare("analyzers.lib/pitchTracker:copyright", "Copyright (C) 2022 Dario Sanfilippo       <sanfilippo.dario@gmail.com>");
		m->declare("analyzers.lib/pitchTracker:license", "MIT License");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = std::exp(-(0.001f / fConst0));
		fConst4 = 3.1415927f / fConst0;
		fConst5 = std::tan(3769.9111f / fConst0);
		...
		fConst11 = std::tan(62.831852f / fConst0);
		fConst12 = 1.0f / (fConst11 * fConst9);
		fConst13 = 1.0f / fConst11;
		fConst14 = 1.0f - fConst13;
		fConst15 = 1.0f / (fConst13 + 1.0f);
		fConst16 = 1.0f - fConst3;
		fConst17 = 0.5f * fConst0;
		fConst18 = 0.0022727272f * fConst0;
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = std::tan(fConst4 * std::max<float>(2e+01f, fRec2[1]));
			float fTemp1 = 1.0f / fTemp0;
			float fTemp2 = (fTemp1 + 0.039267384f) / fTemp0 + 1.0f;
			float fTemp3 = 1.0f - 1.0f / mydsp_faustpower2_f(fTemp0);
			float fTemp4 = (fTemp1 + 0.11774161f) / fTemp0 + 1.0f;
			float fTemp5 = (fTemp1 + 0.19603428f) / fTemp0 + 1.0f;
			float fTemp6 = (fTemp1 + 0.2740247f) / fTemp0 + 1.0f;
			float fTemp7 = (fTemp1 + 0.35159257f) / fTemp0 + 1.0f;
			float fTemp8 = (fTemp1 + 0.4286183f) / fTemp0 + 1.0f;
			float fTemp9 = (fTemp1 + 0.5049831f) / fTemp0 + 1.0f;
			float fTemp10 = (fTemp1 + 0.5805693f) / fTemp0 + 1.0f;
			float fTemp11 = (fTemp1 + 0.6552604f) / fTemp0 + 1.0f;
			float fTemp12 = (fTemp1 + 0.728941f) / fTemp0 + 1.0f;
			float fTemp13 = (fTemp1 + 0.80149764f) / fTemp0 + 1.0f;
			float fTemp14 = (fTemp1 + 0.87281847f) / fTemp0 + 1.0f;
			float fTemp15 = (fTemp1 + 0.9427935f) / fTemp0 + 1.0f;
			float fTemp16 = (fTemp1 + 1.0113147f) / fTemp0 + 1.0f;
			float fTemp17 = (fTemp1 + 1.0782766f) / fTemp0 + 1.0f;
			float fTemp18 = (fTemp1 + 1.1435759f) / fTemp0 + 1.0f;
			float fTemp19 = (fTemp1 + 1.2071118f) / fTemp0 + 1.0f;
			float fTemp20 = (fTemp1 + 1.2687865f) / fTemp0 + 1.0f;
			float fTemp21 = (fTemp1 + 1.3285049f) / fTemp0 + 1.0f;
			float fTemp22 = (fTemp1 + 1.3861747f) / fTemp0 + 1.0f;
			float fTemp23 = (fTemp1 + 1.4417071f) / fTemp0 + 1.0f;
			float fTemp24 = (fTemp1 + 1.4950167f) / fTemp0 + 1.0f;
			float fTemp25 = (fTemp1 + 1.5460209f) / fTemp0 + 1.0f;
			float fTemp26 = (fTemp1 + 1.5946413f) / fTemp0 + 1.0f;
			float fTemp27 = (fTemp1 + 1.6408029f) / fTemp0 + 1.0f;
			float fTemp28 = (fTemp1 + 1.6844344f) / fTemp0 + 1.0f;
			float fTemp29 = (fTemp1 + 1.7254688f) / fTemp0 + 1.0f;
			float fTemp30 = (fTemp1 + 1.7638426f) / fTemp0 + 1.0f;
			float fTemp31 = (fTemp1 + 1.7994965f) / fTemp0 + 1.0f;
			float fTemp32 = (fTemp1 + 1.8323759f) / fTemp0 + 1.0f;
			float fTemp33 = (fTemp1 + 1.8624299f) / fTemp0 + 1.0f;
			float fTemp34 = (fTemp1 + 1.8896121f) / fTemp0 + 1.0f;
			float fTemp35 = (fTemp1 + 1.9138807f) / fTemp0 + 1.0f;
			float fTemp36 = (fTemp1 + 1.9351982f) / fTemp0 + 1.0f;
			float fTemp37 = (fTemp1 + 1.9535317f) / fTemp0 + 1.0f;
			float fTemp38 = (fTemp1 + 1.9688531f) / fTemp0 + 1.0f;
			float fTemp39 = (fTemp1 + 1.9811387f) / fTemp0 + 1.0f;
			float fTemp40 = (fTemp1 + 1.9903694f) / fTemp0 + 1.0f;
			float fTemp41 = (fTemp1 + 1.9965312f) / fTemp0 + 1.0f;
			float fTemp42 = (fTemp1 + 1.9996145f) / fTemp0 + 1.0f;
			float fTemp43 = static_cast<float>(input0[i0]);
			fVec0[IOTA0 & 2047] = fTemp43;
			fRec46[0] = fTemp43 - fConst10 * (fConst8 * fRec46[2] + fConst6 * fRec46[1]);
			float fTemp44 = fRec46[2] + fRec46[0] + 2.0f * fRec46[1];
			fVec1[0] = fTemp44;
			fRec45[0] = -(fConst15 * (fConst14 * fRec45[1] - fConst12 * (fTemp44 - fVec1[1])));
			fRec44[0] = fRec45[0] - (fRec44[2] * ((fTemp1 + -1.9996145f) / fTemp0 + 1.0f) + 2.0f * fRec44[1] * fTemp3) / fTemp42;
			fRec43[0] = (fRec44[2] + fRec44[0] + 2.0f * fRec44[1]) / fTemp42 - (fRec43[2] * ((fTemp1 + -1.9965312f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec43[1]) / fTemp41;
			fRec42[0] = (fRec43[2] + fRec43[0] + 2.0f * fRec43[1]) / fTemp41 - (fRec42[2] * ((fTemp1 + -1.9903694f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec42[1]) / fTemp40;
			fRec41[0] = (fRec42[2] + fRec42[0] + 2.0f * fRec42[1]) / fTemp40 - (fRec41[2] * ((fTemp1 + -1.9811387f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec41[1]) / fTemp39;
			fRec40[0] = (fRec41[2] + fRec41[0] + 2.0f * fRec41[1]) / fTemp39 - (fRec40[2] * ((fTemp1 + -1.9688531f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec40[1]) / fTemp38;
			fRec39[0] = (fRec40[2] + fRec40[0] + 2.0f * fRec40[1]) / fTemp38 - (fRec39[2] * ((fTemp1 + -1.9535317f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec39[1]) / fTemp37;
			fRec38[0] = (fRec39[2] + fRec39[0] + 2.0f * fRec39[1]) / fTemp37 - (fRec38[2] * ((fTemp1 + -1.9351982f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec38[1]) / fTemp36;
			fRec37[0] = (fRec38[2] + fRec38[0] + 2.0f * fRec38[1]) / fTemp36 - (fRec37[2] * ((fTemp1 + -1.9138807f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec37[1]) / fTemp35;
			fRec36[0] = (fRec37[2] + fRec37[0] + 2.0f * fRec37[1]) / fTemp35 - (fRec36[2] * ((fTemp1 + -1.8896121f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec36[1]) / fTemp34;
			fRec35[0] = (fRec36[2] + fRec36[0] + 2.0f * fRec36[1]) / fTemp34 - (fRec35[2] * ((fTemp1 + -1.8624299f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec35[1]) / fTemp33;
			fRec34[0] = (fRec35[2] + fRec35[0] + 2.0f * fRec35[1]) / fTemp33 - (fRec34[2] * ((fTemp1 + -1.8323759f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec34[1]) / fTemp32;
			fRec33[0] = (fRec34[2] + fRec34[0] + 2.0f * fRec34[1]) / fTemp32 - (fRec33[2] * ((fTemp1 + -1.7994965f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec33[1]) / fTemp31;
			fRec32[0] = (fRec33[2] + fRec33[0] + 2.0f * fRec33[1]) / fTemp31 - (fRec32[2] * ((fTemp1 + -1.7638426f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec32[1]) / fTemp30;
			fRec31[0] = (fRec32[2] + fRec32[0] + 2.0f * fRec32[1]) / fTemp30 - (fRec31[2] * ((fTemp1 + -1.7254688f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec31[1]) / fTemp29;
			fRec30[0] = (fRec31[2] + fRec31[0] + 2.0f * fRec31[1]) / fTemp29 - (fRec30[2] * ((fTemp1 + -1.6844344f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec30[1]) / fTemp28;
			fRec29[0] = (fRec30[2] + fRec30[0] + 2.0f * fRec30[1]) / fTemp28 - (fRec29[2] * ((fTemp1 + -1.6408029f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec29[1]) / fTemp27;
			fRec28[0] = (fRec29[2] + fRec29[0] + 2.0f * fRec29[1]) / fTemp27 - (fRec28[2] * ((fTemp1 + -1.5946413f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec28[1]) / fTemp26;
			fRec27[0] = (fRec28[2] + fRec28[0] + 2.0f * fRec28[1]) / fTemp26 - (fRec27[2] * ((fTemp1 + -1.5460209f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec27[1]) / fTemp25;
			fRec26[0] = (fRec27[2] + fRec27[0] + 2.0f * fRec27[1]) / fTemp25 - (fRec26[2] * ((fTemp1 + -1.4950167f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec26[1]) / fTemp24;
			fRec25[0] = (fRec26[2] + fRec26[0] + 2.0f * fRec26[1]) / fTemp24 - (fRec25[2] * ((fTemp1 + -1.4417071f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec25[1]) / fTemp23;
			fRec24[0] = (fRec25[2] + fRec25[0] + 2.0f * fRec25[1]) / fTemp23 - (fRec24[2] * ((fTemp1 + -1.3861747f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec24[1]) / fTemp22;
			fRec23[0] = (fRec24[2] + fRec24[0] + 2.0f * fRec24[1]) / fTemp22 - (fRec23[2] * ((fTemp1 + -1.3285049f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec23[1]) / fTemp21;
			fRec22[0] = (fRec23[2] + fRec23[0] + 2.0f * fRec23[1]) / fTemp21 - (fRec22[2] * ((fTemp1 + -1.2687865f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec22[1]) / fTemp20;
			fRec21[0] = (fRec22[2] + fRec22[0] + 2.0f * fRec22[1]) / fTemp20 - (fRec21[2] * ((fTemp1 + -1.2071118f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec21[1]) / fTemp19;
			fRec20[0] = (fRec21[2] + fRec21[0] + 2.0f * fRec21[1]) / fTemp19 - (fRec20[2] * ((fTemp1 + -1.1435759f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec20[1]) / fTemp18;
			fRec19[0] = (fRec20[2] + fRec20[0] + 2.0f * fRec20[1]) / fTemp18 - (fRec19[2] * ((fTemp1 + -1.0782766f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec19[1]) / fTemp17;
			fRec18[0] = (fRec19[2] + fRec19[0] + 2.0f * fRec19[1]) / fTemp17 - (fRec18[2] * ((fTemp1 + -1.0113147f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec18[1]) / fTemp16;
			fRec17[0] = (fRec18[2] + fRec18[0] + 2.0f * fRec18[1]) / fTemp16 - (fRec17[2] * ((fTemp1 + -0.9427935f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec17[1]) / fTemp15;
			fRec16[0] = (fRec17[2] + fRec17[0] + 2.0f * fRec17[1]) / fTemp15 - (fRec16[2] * ((fTemp1 + -0.87281847f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec16[1]) / fTemp14;
			fRec15[0] = (fRec16[2] + fRec16[0] + 2.0f * fRec16[1]) / fTemp14 - (fRec15[2] * ((fTemp1 + -0.80149764f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec15[1]) / fTemp13;
			fRec14[0] = (fRec15[2] + fRec15[0] + 2.0f * fRec15[1]) / fTemp13 - (fRec14[2] * ((fTemp1 + -0.728941f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec14[1]) / fTemp12;
			fRec13[0] = (fRec14[2] + fRec14[0] + 2.0f * fRec14[1]) / fTemp12 - (fRec13[2] * ((fTemp1 + -0.6552604f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec13[1]) / fTemp11;
			fRec12[0] = (fRec13[2] + fRec13[0] + 2.0f * fRec13[1]) / fTemp11 - (fRec12[2] * ((fTemp1 + -0.5805693f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec12[1]) / fTemp10;
			fRec11[0] = (fRec12[2] + fRec12[0] + 2.0f * fRec12[1]) / fTemp10 - (fRec11[2] * ((fTemp1 + -0.5049831f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec11[1]) / fTemp9;
			fRec10[0] = (fRec11[2] + fRec11[0] + 2.0f * fRec11[1]) / fTemp9 - (fRec10[2] * ((fTemp1 + -0.4286183f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec10[1]) / fTemp8;
			fRec9[0] = (fRec10[2] + fRec10[0] + 2.0f * fRec10[1]) / fTemp8 - (fRec9[2] * ((fTemp1 + -0.35159257f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec9[1]) / fTemp7;
			fRec8[0] = (fRec9[2] + fRec9[0] + 2.0f * fRec9[1]) / fTemp7 - (fRec8[2] * ((fTemp1 + -0.2740247f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec8[1]) / fTemp6;
			fRec7[0] = (fRec8[2] + fRec8[0] + 2.0f * fRec8[1]) / fTemp6 - (fRec7[2] * ((fTemp1 + -0.19603428f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec7[1]) / fTemp5;
			fRec6[0] = (fRec7[2] + fRec7[0] + 2.0f * fRec7[1]) / fTemp5 - (fRec6[2] * ((fTemp1 + -0.11774161f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec6[1]) / fTemp4;
			fRec5[0] = (fRec6[2] + fRec6[0] + 2.0f * fRec6[1]) / fTemp4 - (fRec5[2] * ((fTemp1 + -0.039267384f) / fTemp0 + 1.0f) + 2.0f * fTemp3 * fRec5[1]) / fTemp2;
			float fTemp45 = (fRec5[2] + fRec5[0] + 2.0f * fRec5[1]) / fTemp2;
			fRec4[0] = ((fTemp45 != 0.0f) ? fTemp45 : fRec4[1]);
			fRec3[0] = fConst16 * static_cast<float>((fRec4[0] * fRec4[1]) < 0.0f) + fConst3 * fRec3[1];
			fRec2[0] = fConst17 * fRec3[0];
			float fTemp46 = 17.31234f * std::log(fConst18 / std::max<float>(1.0f, fRec2[0]));
			fRec1[0] = fConst1 * (std::floor(fTemp46 + 69.5f) + (-69.0f - fTemp46)) + fConst2 * fRec1[1];
			fRec0[0] = std::fmod(fRec0[1] + (1.0f - std::pow(2.0f, 0.083333336f * fRec1[0])), 1e+03f);
			float fTemp47 = std::min<float>(0.002f * fRec0[0], 1.0f);
			float fTemp48 = fRec0[0] + 1e+03f;
			float fTemp49 = std::floor(fTemp48);
			int iTemp50 = static_cast<int>(fTemp48);
			int iTemp51 = static_cast<int>(fRec0[0]);
			float fTemp52 = std::floor(fRec0[0]);
			output0[i0] = static_cast<FAUSTFLOAT>((fVec0[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp51))) & 2047] * (fTemp52 + (1.0f - fRec0[0])) + (fRec0[0] - fTemp52) * fVec0[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp51 + 1))) & 2047]) * fTemp47 + (fVec0[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp50))) & 2047] * (fTemp49 + (-999.0f - fRec0[0])) + fVec0[(IOTA0 - std::min<int>(1025, std::max<int>(0, iTemp50 + 1))) & 2047] * (fRec0[0] + (1e+03f - fTemp49))) * (1.0f - fTemp47));
			IOTA0 = IOTA0 + 1;
			fRec46[2] = fRec46[1];
			fRec46[1] = fRec46[0];
			fVec1[1] = fVec1[0];
